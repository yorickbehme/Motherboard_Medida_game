...
var component_texture_happy = load("res://Assets/ram_happy.png")
var component_texture_excited = load("res://Assets/ram_excited.png")

# Called when the node enters the scene tree for the first time.
func _ready():
	var score = GlobalVariables.ramScore
...
func _on_DoneButton_pressed():
	...
	GlobalVariables.setRamScore(GlobalVariables.bestRamScore)
