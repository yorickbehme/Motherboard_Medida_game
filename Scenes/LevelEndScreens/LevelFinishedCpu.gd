...
var component_texture_happy = load("res://Assets/cpu_happy.png")
var component_texture_excited = load("res://Assets/cpu_excited.png")

# Called when the node enters the scene tree for the first time.
func _ready():
	var score = GlobalVariables.cpuScore
...
func _on_DoneButton_pressed():
	...
	GlobalVariables.setCpuScore(GlobalVariables.bestCpuScore)
	get_tree().change_scene("res://Scenes/LevelSelection/LevelSelect.tscn")


func _on_PlayAgainButton_pressed():
	GlobalVariables.setCpuScore(GlobalVariables.bestCpuScore)
	get_tree().change_scene("res://CpuGpu/CpuGame.tscn") # replace with game scene
